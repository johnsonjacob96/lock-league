...
On Parlays, a “PARLAY KILLER” card appears when a saved slip has exactly one settled loss and every other leg won. Leads with the responsible member’s name and “Every other leg hit. Let that sink in.” Labels the lost winnings “THE DAMAGE” and the missed bet “The crime scene,” with “The group chat is waiting for your apology.” Names the assigned member, shows the missed bet and one X among the hit marks, and calculates the potential profit on a fixed $5 stake. +14819 yields $740.95; −120 yields $4.17. The stake return is excluded. This is a playful hypothetical, not money owed or a payment ledger.
