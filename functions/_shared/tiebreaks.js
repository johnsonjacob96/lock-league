...
export function percentage(r) { return r.W + r.L > 0 ? r.W / (r.W + r.L) : null; }
export function seasonMetrics(picks) {
...
export function rankEntries(entries, criteria = WEEKLY_CRITERIA) {
...
export function weeklyEntries(ids, weekPicks, {locked=false, seasonPicks=weekPicks, historical={}} = {}) {
  return ids.map(id => {
